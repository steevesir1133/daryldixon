...
API_ID = int(environ.get('API_ID', '2770539'))
API_HASH = environ.get('API_HASH', 'a980852f0a3c3380e430caddcd44f09e')
BOT_TOKEN = environ.get('BOT_TOKEN', "1937771202:AAEQ2RO7hMiU1ojcRkbDVyfk85Ton994zBk")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001211617457').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://daryldixon:steevesir12@cluster0.yebtf.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001785608788'))
